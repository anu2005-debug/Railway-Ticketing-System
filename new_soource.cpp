...
struct node {
	int ticketID;
	string Name, Age, PNR, Gender, Contact, BookedClass, BookedTName, BookedTID, BookedDest, BookedSource, BookedDate, DeptTime, ArrTime, BookedSeatNum;
	float Price;
	node* next;
};
...
string Name, Age,PNR, Gender, Contact, Dest, Source, SeatNum, Class, TID, Date, ATime, DTime, TName;
...
void Payment()
{
	...
	{
	phoneCheck:
		cout << "\n\n\t\t\t\t\tEnter upi Mobile Account Number: ";
		cin >> accNum;
	...
	{
		cout << "\n\n\t\t\t\t\tEnter irctc wallet Mobile  Number: ";
		cin >> accNum;
...
void iniTrain()
{
	availTrains[0].TName = "Sahid  Express";
	availTrains[0].TID = "12347";
	availTrains[0].TSource = "Howrah";
	availTrains[0].TDest = "Rampurhat";
	availTrains[0].TDate = "24-nov-2024";
	availTrains[0].arriveTime = "11:55 (11:55 AM)";
	availTrains[0].departTime = "15:30 (3:30 PM)";
	availTrains[0].TClasses = "AC Lower,AC Business ,Economy";
	availTrains[0].TSeats = 100;

	availTrains[1].TName = "Howrah Jan Shatabdi Express";
	availTrains[1].TID = "12024";
	availTrains[1].TSource = "Howrah";
	availTrains[1].TDest = "Jasidih";
	availTrains[1].TDate = "08-Dec-2024";
	availTrains[1].arriveTime = "09:25 (9:25 AM)";
	availTrains[1].departTime = "01:25 (1:25 PM)";
	availTrains[1].TClasses = "AC Lower,AC Business ,Economy";
	availTrains[1].TSeats = 110;

	availTrains[2].TName = "Mumbai Central Rajdani Express";
	availTrains[2].TID = "12952";
	availTrains[2].TSource = "New Delhi";
	availTrains[2].TDest = "Mumbai";
	availTrains[2].TDate = "10-feb-2024";
	availTrains[2].arriveTime = "04:55 (04:55 PM)";
	availTrains[2].departTime = "08:35 (08:35 AM)";
	availTrains[2].TClasses = "AC Lower,AC  Business ,Economy";
	availTrains[2].TSeats = 60;


	availTrains[3].TName = "Dehradun Shatabdi Express";
	availTrains[3].TID = "12017";
	availTrains[3].TSource = "New Delhi";
	availTrains[3].TDest = "Dehradun";
	availTrains[3].TDate = "01-Jan-2024";
	availTrains[3].arriveTime = "06:45 (06:45 AM)";
	availTrains[3].departTime = "12:54 (12:54 PM)";
	availTrains[3].TClasses = " AC Lower,AC  Business ,Economy ";
	availTrains[3].TSeats = 80;

	availTrains[4].TName = "New Jalpaiguri Vande Bharat";
	availTrains[4].TID = "222301";
	availTrains[4].TSource = "Howrah Junction";
	availTrains[4].TDest = "New jalpaiguri";
	availTrains[4].TDate = "31-Dec-2024";
	availTrains[4].arriveTime = "5:55 (5:55 AM)";
	availTrains[4].departTime = "01:25 (01:25 PM)";
	availTrains[4].TClasses = "AC Lower,AC Business ,Economy";
	availTrains[4].TSeats = 90;
...
void trainPrice()
{
	...
	cout << "\t\t\t\t\t1. Economy \t\t 2500 INR \n";
	cout << "\t\t\t\t\t2. AC Lower \t\t 3500 INR \n";
	cout << "\t\t\t\t\t3. AC Business \t\t 4500 INR \n\n";
...
nicCheck:
	...
	if (PNR.length() != 13 || PNR.length() > 13)
	{
		cout << endl;
		cout << "\t\t\t\t\tEnter a Valid 13 digit PNR Number!" << endl << endl;
		goto nicCheck;
	}
...
phoneCheck:
	...
	{
		cout << endl;
		cout << "\t\t\t\t\tEnter a Valid 10 digit Mobile Phone Number!" << endl;
		goto phoneCheck;
	}
	cin.clear();
...
login:
	...
	if (user == "ANUSHKA" && password == "ANUSHKA123" )
	{
